		...
		<div class="cont-ubi-elementos-principales">
			<nav class="nav-lateral">
				...
				<div id="cont-menu">
					<div class="sidebar">
			            ...
			            <a href="VISTAS/pre-nomina.php" id="op-main" onclick="showMenu('menu1')">
			               <span id="icon-sidebar" class="material-symbols-outlined">inventory</span>
			               <span id="txt-sidebar" >Pre-Nomina</span>
			            </a>
			            <a href="VISTAS/liquidador.php" id="op-main" onclick="showMenu('menu1')">
			...
			<div class="cont-datos">
				<div class="cont-tabla-resultado">
					<form id="formularioNomina" action="" method="post">
						<!-- <div id="contendorFiltros">
							<div class="filtros" id="cont-filtro1">

							</div>
							<div class="filtros" id="cont-filtro2">

							</div>
							<div class="filtros" id="cont-filtro3">
								<select name="SelectorTablaNomina" id="SelectorTablaNomina">
									<option selected>Seleccionar</option>
									<option value="Transpormax" >Transpormax</option>
									<option value="Logistic" >Logistic</option>
									<option value="Asesoria" >Consorsio</option>
								</select>
							</div>
						</div> -->
							...
							<div id="contenedor-nomina">
								<table>
									<thead id="fila-titulo-tabla-nommina">
										...
										<th id="dato14" class="consulta-Resultado-Datos">VALOR</th>
										...
										<th id="dato22" class="consulta-Resultado-Datos">HEDO125</th>
										<th id="dato23" class="consulta-Resultado-Datos">HEDO125 CANT</th>
										<th id="dato24" class="consulta-Resultado-Datos">HENO175</th>
										<th id="dato25" class="consulta-Resultado-Datos">HENO175 CANT</th>
										<th id="dato26" class="consulta-Resultado-Datos">RN035</th>
										<th id="dato27" class="consulta-Resultado-Datos">RN035 CANT</th>
										<th id="dato28" class="consulta-Resultado-Datos">RF075</th>
										<th id="dato29" class="consulta-Resultado-Datos">RF075 CANT</th>
										<th id="dato30" class="consulta-Resultado-Datos">HEDDF200</th>
										<th id="dato31" class="consulta-Resultado-Datos" style="min-width: 30vh;">HEDDF200 CANT</th>
										<th id="dato32" class="consulta-Resultado-Datos">HENDF250</th>
										<th id="dato33" class="consulta-Resultado-Datos">HENDF250 CANT</th>
										<th id="dato34" class="consulta-Resultado-Datos">RNDF210</th>
										<th id="dato35" class="consulta-Resultado-Datos">RNDF210 CANT</th>
										<th id="dato36" class="consulta-Resultado-Datos">HD175</th>
										<th id="dato37" class="consulta-Resultado-Datos">HD175 CANT</th>
										...
										<?php
										        ...
										        while ($datos = mysqli_fetch_object($resultado)) {
										            echo "<tr class='tb-resultado-datos'>";
											            ...
											            echo "<th id='dato1' class='consulta-Resultado-Datos'>" . htmlspecialchars($datos->id) . "</th>";
														echo "<th id='dato2' class='consulta-Resultado-Datos'>" . htmlspecialchars($datos->empresa) . "</th>";
														echo "<th id='dato3' class='consulta-Resultado-Datos'>" . htmlspecialchars($datos->proyecto) . "</th>";
														echo "<th id='dato4' class='consulta-Resultado-Datos'>" . htmlspecialchars($datos->identificacion) . "</th>";
														echo "<th id='dato5' class='consulta-Resultado-Datos' style='min-width: 55vh;'>" . htmlspecialchars($datos->nombreapellidos) . "</th>";
														echo "<th id='dato6' class='consulta-Resultado-Datos'>" . htmlspecialchars($datos->cargo) . "</th>";
														echo "<th id='dato7' class='consulta-Resultado-Datos'>" . htmlspecialchars($datos->ingreso) . "</th>";
														echo "<th id='dato8' class='consulta-Resultado-Datos'>" . htmlspecialchars($datos->salariobase) . "</th>";
														echo "<th id='dato9' class='consulta-Resultado-Datos'>" . htmlspecialchars($datos->auxt) . "</th>";
														echo "<th id='dato10' class='consulta-Resultado-Datos'>" . htmlspecialchars($datos->bono) . "</th>";
														echo "<th id='dato11' class='consulta-Resultado-Datos'>" . htmlspecialchars($datos->inicio) . "</th>";
														echo "<th id='dato12' class='consulta-Resultado-Datos'>" . htmlspecialchars($datos->final) . "</th>";
														echo "<th id='dato13' class='consulta-Resultado-Datos'>" . htmlspecialchars($datos->cant) . "</th>";
														echo "<th id='dato14' class='consulta-Resultado-Datos'>" . htmlspecialchars($datos->valordescuentosvl) . "</th>";
														echo "<th id='dato15' class='consulta-Resultado-Datos'>" . htmlspecialchars($datos->periodo) . "</th>";
														echo "<th id='dato16' class='consulta-Resultado-Datos'>" . htmlspecialchars($datos->periodoinicio) . "</th>";
														echo "<th id='dato17' class='consulta-Resultado-Datos'>" . htmlspecialchars($datos->periodofinal) . "</th>";
														echo "<th id='dato18' class='consulta-Resultado-Datos'>" . htmlspecialchars($datos->dias) . "</th>";
														echo "<th id='dato19' class='consulta-Resultado-Datos'>" . htmlspecialchars($datos->salariobasedia) . "</th>";
														echo "<th id='dato20' class='consulta-Resultado-Datos'>" . htmlspecialchars($datos->hora) . "</th>";
														echo "<th id='dato21' class='consulta-Resultado-Datos'>" . htmlspecialchars($datos->auxtcant) . "</th>";
														echo "<th id='dato22' class='consulta-Resultado-Datos'>" . htmlspecialchars($datos->hedo125) . "</th>";
														echo "<th id='dato23' class='consulta-Resultado-Datos'>" . htmlspecialchars($datos->hedo125cant) . "</th>";
														echo "<th id='dato24' class='consulta-Resultado-Datos'>" . htmlspecialchars($datos->heno175) . "</th>";
														echo "<th id='dato25' class='consulta-Resultado-Datos'>" . htmlspecialchars($datos->heno175cant) . "</th>";
														echo "<th id='dato26' class='consulta-Resultado-Datos'>" . htmlspecialchars($datos->rn035) . "</th>";
														echo "<th id='dato27' class='consulta-Resultado-Datos'>" . htmlspecialchars($datos->rn035cant) . "</th>";
														echo "<th id='dato28' class='consulta-Resultado-Datos'>" . htmlspecialchars($datos->rf075) . "</th>";
														echo "<th id='dato29' class='consulta-Resultado-Datos'>" . htmlspecialchars($datos->rf075cant) . "</th>";
														echo "<th id='dato30' class='consulta-Resultado-Datos'>" . htmlspecialchars($datos->heddf200) . "</th>";
														echo "<th id='dato31' class='consulta-Resultado-Datos'  style='min-width: 30vh;'>" . htmlspecialchars($datos->heddf200cant) . "</th>";
														echo "<th id='dato32' class='consulta-Resultado-Datos'>" . htmlspecialchars($datos->hendf250) . "</th>";
														echo "<th id='dato33' class='consulta-Resultado-Datos'>" . htmlspecialchars($datos->hendf250cant) . "</th>";
														echo "<th id='dato34' class='consulta-Resultado-Datos'>" . htmlspecialchars($datos->rndf210) . "</th>";
														echo "<th id='dato35' class='consulta-Resultado-Datos'>" . htmlspecialchars($datos->rndf210cant) . "</th>";
														echo "<th id='dato36' class='consulta-Resultado-Datos'>" . htmlspecialchars($datos->hd175) . "</th>";
														echo "<th id='dato37' class='consulta-Resultado-Datos'>" . htmlspecialchars($datos->hd175cant) . "</th>";
														echo "<th id='dato38' class='consulta-Resultado-Datos'  style='min-width: 40vh;'>" . htmlspecialchars($datos->totalsuplementario) . "</th>";
														echo "<th id='dato39' class='consulta-Resultado-Datos'  style='min-width: 35vh;'>" . htmlspecialchars($datos->bonoextra) . "</th>";
														echo "<th id='dato40' class='consulta-Resultado-Datos'  style='min-width: 35vh;'>" . htmlspecialchars($datos->totaldevengado) . "</th>";
														echo "<th id='dato41' class='consulta-Resultado-Datos'>" . htmlspecialchars($datos->basesssg) . "</th>";
														echo "<th id='dato42' class='consulta-Resultado-Datos'>" . htmlspecialchars($datos->pension) . "</th>";
														echo "<th id='dato43' class='consulta-Resultado-Datos'>" . htmlspecialchars($datos->salud) . "</th>";
														echo "<th id='dato44' class='consulta-Resultado-Datos'>" . htmlspecialchars($datos->fsp) . "</th>";
														echo "<th id='dato45' class='consulta-Resultado-Datos'>" . htmlspecialchars($datos->optometria) . "</th>";
														echo "<th id='dato46' class='consulta-Resultado-Datos'>" . htmlspecialchars($datos->prestamos) . "</th>";
														echo "<th id='dato47' class='consulta-Resultado-Datos'>" . htmlspecialchars($datos->otros) . "</th>";
														echo "<th id='dato48' class='consulta-Resultado-Datos'>" . htmlspecialchars($datos->vacaciones) . "</th>";
														echo "<th id='dato49' class='consulta-Resultado-Datos' style='min-width: 35vh;'>" . htmlspecialchars($datos->totaldeduccion) . "</th>";
														echo "<th id='dato50' class='consulta-Resultado-Datos' style='min-width: 35vh;'>" . htmlspecialchars($datos->totalpagar) . "</th>";
														echo "<th id='dato51' class='consulta-Resultado-Datos' style='min-width: 35vh;'>" . htmlspecialchars($datos->numerocuenta) . "</th>";
														echo "<th id='dato52' class='consulta-Resultado-Datos'>" . htmlspecialchars($datos->tipocuenta) . "</th>";
														echo "<th id='dato53' class='consulta-Resultado-Datos'>" . htmlspecialchars($datos->banco) . "</th>";
														echo "<th id='dato54' class='consulta-Resultado-Datos'>" . htmlspecialchars($datos->observacion) . "</th>";
										            echo "</tr>";
										        }
										    ?>
									</tbody>
