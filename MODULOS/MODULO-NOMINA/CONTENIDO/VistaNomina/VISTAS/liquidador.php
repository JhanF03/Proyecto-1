...
<head>
	...
	<link rel="stylesheet" href="../CSS/liquidador.css">
		...
		<div class="cont-ubi-elementos-principales">
			<nav class="nav-lateral">
				...
				<div id="cont-menu">
					<div class="sidebar">
			            ...
			            <a href="pre-nomina.php" id="op-main" onclick="showMenu('menu1')">
			...
			<div class="cont-datos">
				<div class="cont-tabla-resultado">
					<div id="formularioNomina">
						<div id="contendorbotones">
							<form id="form-btn-calcular" action="../PHP/calculohe.php" method="post">
								<input id="btn-liquidar" name="calcular" type="submit" value="Liquidar">
							</form>
						</div>
