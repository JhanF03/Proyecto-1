				        	...
				        	<table>
					                <thead class="titulo-tabla-resultado">
					                    <tr class="fila-titulo-resultado">
					                        ...
					                        <th id="valoraprobado" class="consulta-Resultado-Datos">VALOR-APROBADO</th>
					                ...
					                <tbody>
					                    ...
					                    while ($datos = mysqli_fetch_object($resultado)) {
					                       ...
					                       // Columna Select
						                    ...
						                    echo "<th id='valoraprobado' class='consulta-Resultado-Datos'>" . htmlspecialchars($datos->valoraprobado) . "</th>";
