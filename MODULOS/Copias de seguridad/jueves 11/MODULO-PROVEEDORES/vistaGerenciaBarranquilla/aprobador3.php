				        	...
				        	<table>
					                <thead class="titulo-tabla-resultado">
					                    <tr class="fila-titulo-resultado">
					                    	...
					                    	<th id="estadodrifinanciera" class="consulta-Resultado-Datos">DIRFINANCIERA</th>
					                    	<th id="estadoC" class="consulta-Resultado-Datos">CARTAGENA</th>
					                        <th id="selectEstado" class="consulta-Resultado-Datos">APROBAR</th>
					                        <th id="txtbox" class="consulta-Resultado-Datos">COMENTAR</th>
					                        <th id="comentarios" class="consulta-Resultado-Datos">COMENTARIO-FINANCIERA</th>
					                    	<th id="comentarios" class="consulta-Resultado-Datos">COMENTARIO-CARTAGENA</th>
					                    	<th id="thaprobacionparcial" class="consulta-Resultado-Datos">VALOR-APROBADO</th>
					                ...
					                <tbody>
					                    ...
					                    while ($datos = mysqli_fetch_object($resultado)) {
					                        ...
					                        echo "<th id='aprobacionparcial' class='consulta-Resultado-Datos'>" . htmlspecialchars($datos->valoraprobado) . "</th>";
