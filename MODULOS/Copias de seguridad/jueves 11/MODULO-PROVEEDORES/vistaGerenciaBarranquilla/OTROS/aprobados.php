	...
	<div class="cont-body">
		...
		<div class="cont-ubi-elementos-principales">
			<nav class="nav-lateral">
				...
				<div id="cont-menu">
					 <div class="sidebar">
				        <a id="op-main" href="#" onclick="toggleMenu('menu1')"> <span class="material-symbols-outlined">menu_open</span>Operaciones</a>
				        	...
				        	<table>
					                <thead class="titulo-tabla-resultado">
					                    <tr class="fila-titulo-resultado">
					                    	...
					                    	<th id="comentar" class="consulta-Resultado-Datos">CARTAGENA</th>
					                        <th id="selectEstado" class="consulta-Resultado-Datos">BARRANQUILLA</th>
					                        <th id="txtbox" class="consulta-Resultado-Datos">COMENTARIO-BARRANQUILLA</th>
