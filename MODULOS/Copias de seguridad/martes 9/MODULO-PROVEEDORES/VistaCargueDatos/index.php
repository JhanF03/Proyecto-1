					...
					<div class="cont-filtro-importe">
						...
						<div id="cont-filtro2" class="cont-filtros-consulta">
							<form action="" method="post">
								<span>Estado</span>
								<Select name="estadoSelect" class="datos-a-consultar">
									<option selected value="">Seleccionar</option>
									<option >Por revisar</option>
									<option value="1">Aprobado</option>
									<option value="2">No Aprobado</option>
									<option value="3">Aprovación Parcial</option>
								</Select>
								...
								<div id="div-btn-clean">
									<a href="index.php" id="limpiar-tabla" ><span class="material-symbols-outlined">mop</span></a>
								</div>
						...
						<table>
							<thead class="titulo-tabla-resultado">
								<tr class="fila-titulo-resultado">
									<th id="CHECK" class="consulta-Resultado-Datos">ESTADO</th>
								...
								<?php
									if ($_SERVER["REQUEST_METHOD"] == "POST") {
									    if (!empty($_POST['estadoSelect']) || !empty($_POST['fechaCausacion'])) {
									        ...
									        include("./PHP/conexion.php"); // Asegúrate de ajustar la ruta según tu estructura de archivos
									        
									        // Escapar y obtener los valores del formulario
									        $Estado = mysqli_real_escape_string($conn, $_POST['estadoSelect']);
									        $FechaCausacion = mysqli_real_escape_string($conn, $_POST['fechaCausacion']);
									        
									        // Construir la consulta SQL con las condiciones
									        $query = "SELECT * FROM tablaproveedores WHERE estado = '$Estado' OR fechacausacion = '$FechaCausacion'";
									        
									        $resultado = mysqli_query($conn, $query);
									        
									        // Verificar y mostrar resultados si existen registros
									        if ($resultado && mysqli_num_rows($resultado) > 0) {
									            while ($datos = mysqli_fetch_object($resultado)) {
									                ...
									                switch ($datos->estado) {
									                    ...
									                    case 2:
									                        ...
									                        break;
									                    case 3:
									                        $estadoTexto = "Por Aprobar";
									                        break;
									                    default:
									                        $estadoTexto = "Desconocido";
									                        break;
									                }
									                echo "<th id='dato1' class='consulta-Resultado-Datos'>" . htmlspecialchars($estadoTexto) . "</th>";
									            ...
									            <div id="sms-nohayregistros">
									                <div id="elementos-sms">
									                    ...
									                    <div id="btn"><a href="index.php">Cerrar</a></div>
									                </div>
									            </div>
									            <?php
									        }
