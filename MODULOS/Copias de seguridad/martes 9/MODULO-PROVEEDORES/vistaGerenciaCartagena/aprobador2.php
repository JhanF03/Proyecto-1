				        	...
				        	<table>
					                <thead class="titulo-tabla-resultado">
					                    <tr class="fila-titulo-resultado">
					                    	<th id="estadodir" class="consulta-Resultado-Datos">ID</th>
					                    	<th id="estadodir" class="consulta-Resultado-Datos">ESTADO</th>
					                        <th id="CHECK" class="consulta-Resultado-Datos">APROBAR</th>
					                        <th id="CHECK" class="consulta-Resultado-Datos">COMENTAR</th>
					                        <th id="comentarios3eros" class="consulta-Resultado-Datos">DIRFINANCIERA</th>
					                        <th id="comentarios3eros" class="consulta-Resultado-Datos">GERENCIA B/QUILLA</th>
					                ...
					                <tbody>
					                    ...
					                    while ($datos = mysqli_fetch_object($resultado)) {
					                    	...
					                    	echo "<th id='comentarios3eros' class='consulta-Resultado-Datos'>" . htmlspecialchars($datos->id) . "</th>";
											...
											echo "<th id='estadodir' class='consulta-Resultado-Datos'>" . htmlspecialchars($displayValue) . "</th>";
					                        
					                       // Columna Select
					                        echo "<th id='dato0' class='consulta-Resultado-Datos'>";
					                        echo "<select id='selecEstado' name='gerenciac[{$datos->id}]'";
					                        ...
					                        echo "<th id='comentarios3eros' class='consulta-Resultado-Datos'>" . htmlspecialchars($datos->comentariodir) . "</th>";
					                        echo "<th id='comentarios3eros' class='consulta-Resultado-Datos'>" . htmlspecialchars($datos->comentariob) . "</th>";
