				        	...
				        	<table>
					                <thead class="titulo-tabla-resultado">
					                    <tr class="fila-titulo-resultado">
					                        ...
					                        <th id="CHECK" class="consulta-Resultado-Datos">ESTADO C</th>
					                        <th id="CHECK" class="consulta-Resultado-Datos">COMENTARIO CARTAGENA</th>
					                        <th id="CHECK" class="consulta-Resultado-Datos">COMENTARIO B/QUILLA</th>
					                ...
					                <tbody>
					                    ...
					                    while ($datos = mysqli_fetch_object($resultado)) {
					                        ...
					                        echo "<select id='selecEstado' name='dirfinanciera[{$datos->id}]'";
					                        ...
					                        $dirfinancieraValue = $datos->gerenciacartagena;
					                        ...
					                        echo "<th id='comentarios3eros' class='consulta-Resultado-Datos'>" . htmlspecialchars($datos->comentarioc) . "</th>";
