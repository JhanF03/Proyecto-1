				...
				<div id="cont-menu">
					 <div class="sidebar">
				        ...
				        <div id="menu1" class="submenu">
				            <a href="./OTROS/aprobados.php"> <span id="ico" class="material-symbols-outlined">check_circle</span> <span id="txt">Aprobaciones</span> </a>
				            <a href="OTROS/Historico/historicopagos.php"> <span id="ico" class="material-symbols-outlined">history</span><span id="txt">Historico</span> </a>
				        </div>
				    </div>
				</div>
			</nav>
				        ...
				        <div class="cont-tabla">
				        	<table>
					                    ...
					                    <tr class="fila-titulo-resultado">
					                    	<th id="menudesplegable">
							                    ...
							                    <div id="dropdownMenu" class="dropdown-content">
							                    	...
							                    	<label><input id="dato3" type="checkbox" onclick="toggleColumnVisibility(event, 3)" checked> APROBAR</label>
							                        <label><input id="dato4" type="checkbox" onclick="toggleColumnVisibility(event, 4)" checked> APROBACION P</label>
										            <label><input id="dato5" type="checkbox" onclick="toggleColumnVisibility(event, 5)" checked> COMENTAR</label>
										            <label><input id="dato6" type="checkbox" onclick="toggleColumnVisibility(event, 6)" checked> COMENTARIO-FINANCIERA</label>
										            <label><input id="dato7" type="checkbox" onclick="toggleColumnVisibility(event, 7)" checked> COMENTARIO B/QUILLA</label>
										            ...
										            <div id="content-close">
										            	<a id="closeMenu" href="aprobador2.php">Restablecer</a>
							                     	</div>   	
							                    </div>
							                </th>
					                        ...
					                        <th id="dato4" class="consulta-Resultado-Datos">APROBACION P</th>
					                        <th id="dato5" class="consulta-Resultado-Datos">COMENTAR</th>
					                        <th id="dato6" class="consulta-Resultado-Datos">COMENTARIO-FINANCIERA</th>
					                        <th id="dato7" class="consulta-Resultado-Datos">COMENTARIO B/QUILLA</th>
					                        ...
					                        <th id="dato14" class="consulta-Resultado-Datos">MES-DE-PROGRAMACION</th>
					                        <th id="dato15" class="consulta-Resultado-Datos">MES-DEL-SERV</th>
					                        <th id="dato16" class="consulta-Resultado-Datos">N°FAC-CC</th>
					                        <th id="dato17" class="consulta-Resultado-Datos">REFERENCIA</th>
					                        <th id="dato18" class="consulta-Resultado-Datos">CONCEPTO</th>
					                        <th id="dato19" class="consulta-Resultado-Datos">SUBCONCEPTO</th>
					                        ...
					                        <th id="dato23" class="consulta-Resultado-Datos">OBSERVACION-DEL-MOVIMIENTO</th>
					                        <th id="dato24" class="consulta-Resultado-Datos">PLACA</th>
					                        <th id="dato25" class="consulta-Resultado-Datos">RUTA</th>
					                        ...
					                        <th id="dato33" class="consulta-Resultado-Datos">%-RETE</th>
					                        ...
					                        <th id="dato41" class="consulta-Resultado-Datos">VALOR-PAGAGO</th>
					                ...
					                <tbody>
					                    <?php
					                    include("./PHP/conexion.php");
					                    $query = "SELECT * FROM tablaproveedores WHERE (dirfinanciera IN (2, 3) AND gerenciacartagena = 0) OR (dirfinanciera IN (2, 3) AND gerenciabarranquilla = 1) OR (dirfinanciera = 4 AND gerenciabarranquilla = 1)" ;
					                    ...
					                    while ($datos = mysqli_fetch_object($resultado)) {
					                       ...
					                       // Columna Select
					                        ...
					                        echo "<select class='selectorEstado' id='Estado' name='gerenciac[{$datos->id}]'";
