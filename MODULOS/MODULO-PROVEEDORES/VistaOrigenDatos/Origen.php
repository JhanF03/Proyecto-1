				...
				<div id="cont-menu">
					 <div class="sidebar">
				        ...
				        <div id="menu1" class="submenu">
				            ...
				            <a href="./CONTENIDO/vistaEstado.php"> <span id="ico" class="material-symbols-outlined">radio_button_checked</span><span id="txt">Estado</span> </a>
			...
			<div class="cont-datos">
				<div class="ubi-tabla-datos">
					<div class="cont-filtro-importe">
						...
						<div id="cont-filtro2" class="cont-filtros-consulta">
							<form action="" method="post">
								<span id="span-data" >Fecha Causión</span>
					...
					<div class="cont-tabla-resultado">
						<form id="formulario" action="./PHP/actualizarRegistros.php" method="post">
							<div id="cont-table">
								<table>
									<thead class="titulo-tabla-resultado">
										<tr class="fila-titulo-resultado">
											...
											<th id="dato3" class="consulta-Resultado-Datos">APROBAR</th>
											<th id="dato4" class="consulta-Resultado-Datos">COMENTAR</th>
											<th id="dato5" class="consulta-Resultado-Datos">COMENTARIO-DIR</th>
										    <th id="dato6" class="consulta-Resultado-Datos">EMPRESA</th>
										    <th id="dato7" class="consulta-Resultado-Datos">CONCEPTO-PROYECCION</th>
										    <th id="dato8" class="consulta-Resultado-Datos">C-COSTO</th>
										    <th id="dato9" class="consulta-Resultado-Datos">EPS</th>
										    <th id="dato10" class="consulta-Resultado-Datos">FECHA-CAUSACION</th>
										    <th id="dato11" class="consulta-Resultado-Datos">FECHA-PROGRAMACION</th>
										    <th id="dato12" class="consulta-Resultado-Datos">MES-DE-PROGRAMACION</th>
										    <th id="dato13" class="consulta-Resultado-Datos">MES-DEL-SERV</th>
										    <th id="dato14" class="consulta-Resultado-Datos">N°FAC-CC</th>
										    <th id="dato15" class="consulta-Resultado-Datos">REFERENCIA</th>
										    <th id="dato16" class="consulta-Resultado-Datos">CONCEPTO</th>
										    <th id="dato17" class="consulta-Resultado-Datos">SUBCONCEPTO</th>
										    <th id="dato18" class="consulta-Resultado-Datos">TIPO-DOC</th>
										    <th id="dato19" class="consulta-Resultado-Datos">DOC-BENEFICIARIo</th>
										    <th id="dato20" class="consulta-Resultado-Datos">NOMBRE-DE-TERCERO</th>
										    <th id="dato21" class="consulta-Resultado-Datos">OBSERVACION-DEL-MOVIMIENTO</th>
										    <th id="dato22" class="consulta-Resultado-Datos">PLACA</th>
										    <th id="dato23" class="consulta-Resultado-Datos">RUTA</th>
										    <th id="dato24" class="consulta-Resultado-Datos">FECHA-DEBITO-AUTO</th>
										    <th id="dato25" class="consulta-Resultado-Datos">VALOR-BASE</th>
										    <th id="dato26" class="consulta-Resultado-Datos">IVA</th>
										    <th id="dato27" class="consulta-Resultado-Datos">SOBRETASA</th>
										    <th id="dato28" class="consulta-Resultado-Datos">VALOR-TOTAL</th>
										    <th id="dato29" class="consulta-Resultado-Datos">CONCEPTO-DE-RETENCIÓN</th>
										    <th id="dato30" class="consulta-Resultado-Datos">BASE-MÍNIMA-EN-PESOS</th>
										    <th id="dato31" class="consulta-Resultado-Datos">%-RETE</th>
										    <th id="dato32" class="consulta-Resultado-Datos">VALOR-RETE</th>
										    <th id="dato33" class="consulta-Resultado-Datos">VALOR-NETO</th>
										    <th id="dato34" class="consulta-Resultado-Datos">ANTICIPO</th>
										    <th id="dato34" class="consulta-Resultado-Datos">ABONO</th>
										    <th id="dato35" class="consulta-Resultado-Datos">DESCUENTO</th>
										    <th id="dato36" class="consulta-Resultado-Datos">VALOR-A-PAGAR</th>
										    <th id="dato37" class="consulta-Resultado-Datos">FECHA-PAGO</th>
										    <th id="dato38" class="consulta-Resultado-Datos">VALOR-PAGAGO</th>
										    <th id="dato39" class="consulta-Resultado-Datos">OBSERVACION</th>
										    <th id="dato40" class="consulta-Resultado-Datos">CONSUMO-SEMANAL</th>
										    <th id="dato41" class="consulta-Resultado-Datos">CSC-REFERENCIA</th>
										</tr>
									</thead>
									<tbody>
										<?php
							                include("./PHP/conexion.php");
							                $query = "SELECT * FROM tablaproveedores WHERE dirfinanciera = 1" ;
							                $resultado = mysqli_query($conn, $query);
							                    while ($datos = mysqli_fetch_object($resultado)) {
							                       ...
							                       // Columna Select
							                        ...
							                        echo "<select class='selectorEstado' id='Estado' name='agentec[{$datos->id}]'";
							                        	echo "<option value='null'></option>";
							                        	echo "<option selected>Seleccionar</option>";
							                        	echo "<option value='5'>Revisado</option>";
							                        echo "</select>";
							                        echo "</th>";
							                        
							                        // Columna Textarea
							                        echo "<th id='txtbox' class='consulta-Resultado-Datos'>";
							                        echo "<textarea id='textarea' name='comentarioagentec[" . $datos->id . "]'></textarea>";
							                        echo "</th>";
