			...
			<div id="sub-cont-nav2" class="sub-cont-nav">
				<?php 
						if ($resultado && mysqli_num_rows($resultado) > 0) {
				            ...
				            echo "<span><span> Bienvenido </span> " .$datos->nombre . "</span>";
				            }
				        } else {
			...
			<nav class="nav-lateral">
				...
				<div id="cont-menu">
		            ...
		            <div id="menu1" class="submenu">
		               <a href="../aprobador3.php">
		                  <span id="ico" class="material-symbols-outlined">Home</span>
		                  <span id="txt">Home</span>
		               </a>
		               <a href="Historico/historicopagos.php">
      ...
      function showMenu(menuId) {
         ...
         if (menu.classList.contains('show')) {
            ...
            setTimeout(() => {
               ...
               links.forEach((link, index) => {
                  link.style.transitionDelay = `${index * 0.2}s`; // Ajusta el retraso según tus necesidades
               });
            }, 0);
         }
      }
