				...
				<div id="cont-menu">
					 <div class="sidebar">
				        ...
				        <div id="menu1" class="submenu">
				        	<a href=" ../../aprobador3.php"> <span id="ico" class="material-symbols-outlined">home</span> <span id="txt">Home</span> </a>
				            <a href="../aprobados.php"> <span id="ico" class="material-symbols-outlined">history</span><span id="txt">Aprobaciones</span> </a>
				        </div>
				    </div>
				</div>
			</nav>
				        ...
				        <div class="cont-tabla">
				        	<table>
					                <thead class="titulo-tabla-resultado">
					                    <tr class="fila-titulo-resultado">
					                    	<th id="menudesplegable">
							                  ...
							                  <div id="dropdownMenu" class="dropdown-content">
										            ...
										            <label><input id="dato3" type="checkbox" onclick="toggleColumnVisibility(event, 3)" checked> CONCEPTO-PROYECCION</label>
										            <label><input id="dato4" type="checkbox" onclick="toggleColumnVisibility(event, 4)" checked> C-COSTO</label>
										            <label><input id="dato5" type="checkbox" onclick="toggleColumnVisibility(event, 5)" checked> EPS</label>
										            <label><input id="dato6" type="checkbox" onclick="toggleColumnVisibility(event, 6)" checked> FECHA-CAUSACION</label>
										            <label><input id="dato7" type="checkbox" onclick="toggleColumnVisibility(event, 7)" checked> FECHA-PROGRAMACION</label>
										            <label><input id="dato8" type="checkbox" onclick="toggleColumnVisibility(event, 8)" checked> MES-DE-PROGRAMACION</label>
										            <label><input id="dato9" type="checkbox" onclick="toggleColumnVisibility(event, 9)" checked> MES-DEL-SERV</label>
										            <label><input id="dato10" type="checkbox" onclick="toggleColumnVisibility(event, 10)" checked> N°FAC-CC</label>
										            <label><input id="dato11" type="checkbox" onclick="toggleColumnVisibility(event, 11)" checked> REFERENCIA</label>
										            <label><input id="dato12" type="checkbox" onclick="toggleColumnVisibility(event, 12)" checked> CONCEPTO</label>
										            <label><input id="dato13" type="checkbox" onclick="toggleColumnVisibility(event, 13)" checked> SUBCONCEPTO</label>
										            <label><input id="dato14" type="checkbox" onclick="toggleColumnVisibility(event, 14)" checked> TIPO-DOC</label>
										            <label><input id="dato15" type="checkbox" onclick="toggleColumnVisibility(event, 15)" checked> N°-DOC-BENEFICIARIO</label>
										            <label><input id="dato16" type="checkbox" onclick="toggleColumnVisibility(event, 16)" checked> NOMBRE-DE-TERCERO</label>
										            <label><input id="dato17" type="checkbox" onclick="toggleColumnVisibility(event, 17)" checked> OBSERVACION-DEL-MOVIMIENTO</label>
										            <label><input id="dato18" type="checkbox" onclick="toggleColumnVisibility(event, 18)" checked> PLACA</label>
										            <label><input id="dato19" type="checkbox" onclick="toggleColumnVisibility(event, 19)" checked> RUTA</label>
										            <label><input id="dato20" type="checkbox" onclick="toggleColumnVisibility(event, 20)" checked> FECHA-DEBITO-AUTO</label>
										            <label><input id="dato21" type="checkbox" onclick="toggleColumnVisibility(event, 21)" checked> VALOR-BASE</label>
										            <label><input id="dato22" type="checkbox" onclick="toggleColumnVisibility(event, 22)" checked> IVA</label>
										            <label><input id="dato23" type="checkbox" onclick="toggleColumnVisibility(event, 23)" checked> SOBRETASA</label>
										            <label><input id="dato24" type="checkbox" onclick="toggleColumnVisibility(event, 24)" checked> VALOR-TOTAL</label>
										            <label><input id="dato25" type="checkbox" onclick="toggleColumnVisibility(event, 25)" checked> CONCEPTO-DE-RETENCIÓN</label>
										            <label><input id="dato26" type="checkbox" onclick="toggleColumnVisibility(event, 26)" checked> BASE-MÍNIMA-EN-PESOS</label>
										            <label><input id="dato27" type="checkbox" onclick="toggleColumnVisibility(event, 27)" checked> %-RETE</label>
										            <label><input id="dato28" type="checkbox" onclick="toggleColumnVisibility(event, 28)" checked> VALOR-RETE</label>
										            <label><input id="dato29" type="checkbox" onclick="toggleColumnVisibility(event, 29)" checked> VALOR-NETO</label>
										            <label><input id="dato30" type="checkbox" onclick="toggleColumnVisibility(event, 30)" checked> ANTICIPO</label>
										            <label><input id="dato31" type="checkbox" onclick="toggleColumnVisibility(event, 31)" checked> ABONO</label>
										            <label><input id="dato32" type="checkbox" onclick="toggleColumnVisibility(event, 32)" checked> DESCUENTO</label>
										            <label><input id="dato33" type="checkbox" onclick="toggleColumnVisibility(event, 33)" checked> SALDO NO PAGADO</label>
										            <label><input id="dato34" type="checkbox" onclick="toggleColumnVisibility(event, 34)" checked> VALOR-A-PAGAR</label>
										            <label><input id="dato35" type="checkbox" onclick="toggleColumnVisibility(event, 35)" checked> FECHA-PAGO</label>
										            <label><input id="dato36" type="checkbox" onclick="toggleColumnVisibility(event, 36)" checked> VALOR-PAGADO</label>
										            <label><input id="dato37" type="checkbox" onclick="toggleColumnVisibility(event, 37)" checked> OBSERVACION</label>
										            <label><input id="dato38" type="checkbox" onclick="toggleColumnVisibility(event, 38)" checked> CONSUMO-SEMANAL</label>
										            <label><input id="dato39" type="checkbox" onclick="toggleColumnVisibility(event, 39)" checked> CSC-REFERENCIA</label>
					                    ...
					                    <th id="dato3" class="consulta-Resultado-Datos">CONCEPTO-PROYECCION</th>
					                    <th id="dato4" class="consulta-Resultado-Datos">C-COSTO</th>
					                    <th id="dato5" class="consulta-Resultado-Datos">EPS</th>
					                    <th id="dato6" class="consulta-Resultado-Datos">FECHA-CAUSACION</th>
					                    <th id="dato7" class="consulta-Resultado-Datos">FECHA-PROGRAMACION</th>
					                    <th id="dato8" class="consulta-Resultado-Datos mdp">MES-DE-PROGRAMACION</th>
					                    <th id="dato9" class="consulta-Resultado-Datos mds">MES-DEL-SERV</th>
					                    <th id="dato10" class="consulta-Resultado-Datos nfc">N°FAC-CC</th>
					                    <th id="dato11" class="consulta-Resultado-Datos">REFERENCIA</th>
					                    <th id="dato12" class="consulta-Resultado-Datos">CONCEPTO</th>
					                    <th id="dato13" class="consulta-Resultado-Datos SUBCONCEPTO">SUBCONCEPTO</th>
					                    <th id="dato14" class="consulta-Resultado-Datos">TIPO-DOC</th>
					                    <th id="dato15" class="consulta-Resultado-Datos">DOC-BENEFICIARIO</th>
					                    <th id="dato16" class="consulta-Resultado-Datos">NOMBRE-DE-TERCERO</th>
					                    <th id="dato17" class="consulta-Resultado-Datos">OBSERVACION</th>
					                    <th id="dato18" class="consulta-Resultado-Datos PLACA">PLACA</th>
					                    <th id="dato19" class="consulta-Resultado-Datos RUTA">RUTA</th>
					                    <th id="dato20" class="consulta-Resultado-Datos">FECHA-DEBITO-AUTO</th>
					                    <th id="dato21" class="consulta-Resultado-Datos">VALOR-BASE</th>
					                    <th id="dato22" class="consulta-Resultado-Datos">IVA</th>
					                    <th id="dato23" class="consulta-Resultado-Datos">SOBRETASA</th>
					                    <th id="dato24" class="consulta-Resultado-Datos">VALOR-TOTAL</th>
					                    <th id="dato25" class="consulta-Resultado-Datos">CONCEPTO-DE-RETENCIÓN</th>
					                    <th id="dato26" class="consulta-Resultado-Datos">BASE-MÍNIMA-EN-PESOS</th>
					                    <th id="dato27" class="consulta-Resultado-Datos">PORCENTAJE-RETE</th>
					                    <th id="dato28" class="consulta-Resultado-Datos">VALOR-RETE</th>
					                    <th id="dato29" class="consulta-Resultado-Datos">VALOR-NETO</th>
					                    <th id="dato30" class="consulta-Resultado-Datos">ANTICIPO</th>
					                    <th id="dato31" class="consulta-Resultado-Datos">ABONO</th>
					                    <th id="dato32" class="consulta-Resultado-Datos">DESCUENTO</th>
					                    <th id="dato33" class="consulta-Resultado-Datos">SALDO NO PAGADO</th>
					                    <th id="dato34" class="consulta-Resultado-Datos">VALOR-A-PAGAR</th>
					                    <th id="dato35" class="consulta-Resultado-Datos">FECHA-PAGO</th>
					                    <th id="dato36" class="consulta-Resultado-Datos">VALOR-PAGADO</th>
					                    <th id="dato37" class="consulta-Resultado-Datos">OBSERVACION</th>
					                    <th id="dato38" class="consulta-Resultado-Datos">CONSUMO-SEMANAL</th>
					                    <th id="dato39" class="consulta-Resultado-Datos">CSC-REFERENCIA</th>
					                    </tr>
					                </thead>
					                <tbody>
					                    <?php
					                    include("PHP/conexion.php");
					                    $query = "SELECT * FROM tablaproveedores WHERE estadofinal = 1";
